...
class ANN:
    ...
    def __init__(self, 
        ...
        self.output_filename = RESULTS_DIR + '/' + self.input_filename.split('/')[-1] + '-ANNRESULTS.xlsx'
        ...
        excel_headers = ['Patience', 'Hidden Nodes', 'Batch Size', 'Epochs', 'Overall Sens', 'Overall Spec']
        self.CATEGORY_INDEX = {excel_header:i for (excel_header, i) in zip(excel_headers, range(0,len(excel_headers)))}
        ...
        if self.class_number == 3:
            ...
            for patience in self.patience_range:
                ...
                for hidden_nodes in self.hidden_range:
                    ...
                    self.data.write(i, self.CATEGORY_INDEX['Hidden Nodes'], hidden_nodes)
                    
                    for batch_size in self.batch_range:
                        
                        self.data.write(i, self.CATEGORY_INDEX['Batch Size'], batch_size)

                        for epochs in self.epochs_range:
                            
                            self.data.write(i, self.CATEGORY_INDEX['Epochs'], epochs)
                            ...
                            for c in range (0, self.runs):
                                ...
                                model.add(Dense(hidden_nodes, input_dim = self.num_pcs, activation=self.activation))
                                ...
                                results = confusion_matrix(y_predVals, y_testVals)
                            ...
                            averagesens = (overallsens1 + overallsens2 + overallsens3) / 3 # + overallsens4
                            averagespec = (overallspec1 + overallspec2 + overallspec3) / 3 #+ overallsens4
                            
                            self.data.write(i, self.CATEGORY_INDEX['Overall Sens'], averagesens)
                            self.data.write(i, self.CATEGORY_INDEX['Overall Spec'], averagespec)
                    ...
                    for batch_size in self.batch_range:
                        ...
                        for epochs in self.epochs_range:
                            ...
                            for c in range (0, self.runs):
                                ...
                                #for 4 class: 
                                sens1 = results[0][0] / (results[0][0] + results[1][0] + results[2][0] + results[3][0])
                                sens2 = results[1][1] / (results[0][1] + results[1][1] + results[2][1] + results[3][1])
                                sens3 = results[2][2] / (results[0][2] + results[1][2] + results[2][2] + results[3][2])
                                sens4 = results[3][3] / (results[0][3] + results[1][3] + results[2][3] + results[3][3])
                                
                                spec1 = (results[1][1] + results[1][2] + results[1][3] + results[2][1] + results[2][2] + results[2][3] + results[3][1] + results[3][2] + results[3][3]) / (results[0][1] + results[0][2] + results[0][3] + results[1][1] + results[1][2] + results[1][3] + results[2][1] + results[2][2] + results[2][3] + results[3][1] + results[3][2] + results[3][3])
                                spec2 = (results[0][0] + results[2][0] + results[3][0] + results[0][2] + results[0][3] + results[2][2] + results[2][3] + results[3][2] + results[3][3]) / (results[0][0] + results[1][0] + results[2][0] + results[3][0] + results[0][2] + results[0][3] + results[1][2] + results[1][3] + results[2][2] + results[2][3] + results[3][2] + results[3][3])
                                spec3 = (results[0][0] + results[0][1] + results[1][0] + results[1][1] + results[3][0] + results[3][1] + results[0][3] + results[1][3] + results[3][3]) / (results[0][0] + results[0][1] + results[1][0] + results[1][1] + results[2][0] + results[2][1] + results[3][0] + results[3][1] + results[0][3] + results[1][3] + results[2][3] + results[3][3])
                                spec4 = (results[0][0] + results[0][1] + results[0][2] + results[1][0] + results[1][1] + results[1][2] + results[2][0] + results[2][1] + results[2][2]) / (results[0][0] + results[0][1] + results[0][2] + results[1][0] + results[1][1] + results[1][2] + results[2][0] + results[2][1] + results[2][2] + results[3][0] + results[3][1] + results[3][2])
                            ...
                            # sens and spec averaged over all classes over specified number of runs
                            averagesens = (overallsens1 + overallsens2 + overallsens3 + overallsens4) / 4 # + overallsens4
                            averagespec = (overallspec1 + overallspec2 + overallspec3 + overallsens4) / 4 #+ overallsens4
